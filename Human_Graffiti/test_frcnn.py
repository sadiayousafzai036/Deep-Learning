...
parser.add_option("--config_filename", dest="config_filename", help=
                                ...
                                default="/home/hassan/anaconda3/lib/python3.7/site-packages/tensorflow/models/research/object_detection/config.pickle")
...
#Here I created a list of 4 entries that contains the real coordinates
                        ...
                        textLabel = '{}: {}'.format("Human",int(100*new_probs[jk]))
                        all_dets.append(("Human",100*new_probs[jk]))

                        textOrg = (real_x1, real_y1-0)

                        cv2.putText(img, textLabel, textOrg, cv2.FONT_HERSHEY_DUPLEX, fontScale = 0.4, color = (255, 255, 0), thickness = 0)

        print('Elapsed time = {}'.format(time.time() - st))
        print(all_dets)
        
        cv2.imwrite('result_images/{}.png'.format(img_name),img)
